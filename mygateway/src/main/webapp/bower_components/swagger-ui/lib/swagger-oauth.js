  ...
  popupDialog = $(
    [
      ...
      '<div class="api-popup-content">',
        ...
        '</ul>',
        '<p class="error-msg"></p>',
        '<div class="api-popup-actions"><button class="api-popup-authbtn api-button green" type="button">Authorize</button><button class="api-popup-cancel api-button gray" type="button">Anuluj</button></div>',
      '</div>',
      '</div>'].join(''));
